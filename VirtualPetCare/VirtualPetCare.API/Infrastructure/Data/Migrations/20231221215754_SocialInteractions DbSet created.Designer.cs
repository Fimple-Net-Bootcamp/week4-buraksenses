...
namespace VirtualPetCare.API.Migrations
{
    ...
    [Migration("20231221215754_SocialInteractions DbSet created")]
    partial class SocialInteractionsDbSetcreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetSocialInteraction", b =>
                {
                    ...
                    b.Property<Guid>("SocialInteractionsId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("VirtualPetCare.API.Domain.Entities.SocialInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PetSocialInteraction", b =>
                {
                    b.HasOne("VirtualPetCare.API.Domain.Entities.Pet", null)
                        .WithMany()
                        .HasForeignKey("PetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VirtualPetCare.API.Domain.Entities.SocialInteraction", null)
                        .WithMany()
